                                ...
                                userInfo && userInfo.role === 'admin' ?
                                    <>
                                        <MenuItem onClick={handleCloseUserMenu}>
                                            <Typography textAlign="center"><Link style={{ textDecoration: "none" }} to="/admin/dashboard">Admin Dashboard</Link></Typography>
                                        </MenuItem>
                                    </> :
                                    <MenuItem onClick={handleCloseUserMenu}>
                                        <Typography textAlign="center"><Link style={{ textDecoration: "none" }} to="/user/dashboard">Dashboard</Link></Typography>
                                    </MenuItem>
                            }
